...
def solution_A4():
    ...
    model = tf.keras.Sequential([
        ...
        tf.keras.layers.Dense(24, 'relu', kernel_regularizer=tf.keras.regularizers.l2()),
        tf.keras.layers.Dropout(0.25),
        # YOUR CODE HERE. Do not change the last layer.
        tf.keras.layers.Dense(1, activation='sigmoid')
    ])

    adam = tf.keras.optimizers.Adam(learning_rate=0.0001, beta_1=0.9, beta_2=0.99, amsgrad=False)
